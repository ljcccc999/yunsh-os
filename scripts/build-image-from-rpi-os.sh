...
echo "set_inode_field /usr/bin/yunsh-update-daemon permissions 0o755" >> "${DEBUGFS_SCRIPT}"
echo "set_inode_field /usr/bin/yunsh-updater permissions 0o755" >> "${DEBUGFS_SCRIPT}"
echo "set_inode_field /usr/bin/yunsh-network-daemon permissions 0o755" >> "${DEBUGFS_SCRIPT}"
echo "set_inode_field /usr/bin/yunsh-bluetooth-daemon permissions 0o755" >> "${DEBUGFS_SCRIPT}"
echo "set_inode_field /usr/bin/yunsh-screenshotd permissions 0o755" >> "${DEBUGFS_SCRIPT}"
echo "set_inode_field /usr/bin/yunsh-factory-reset permissions 0o755" >> "${DEBUGFS_SCRIPT}"
echo "set_inode_field /usr/bin/yunsh-install-progress.sh permissions 0o755" >> "${DEBUGFS_SCRIPT}"
echo "set_inode_field /usr/bin/yunsh-inputd permissions 0o755" >> "${DEBUGFS_SCRIPT}"
echo "set_inode_field /usr/bin/yunsh-powerd permissions 0o755" >> "${DEBUGFS_SCRIPT}"
echo "set_inode_field /usr/bin/yunsh-firstboot.sh permissions 0o755" >> "${DEBUGFS_SCRIPT}"
